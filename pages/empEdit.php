...
<body>
    ...
    <div class="container">
        <h2 style="text-align: center; margin-bottom: 8px;">Update Employee Details</h2>
        <?php
        ...
        <form action="code/empCode.php" method="post">           
            ...
            <input type="hidden" name="realname" id="" value="<?php echo $name;?>">
            <input type="hidden" name="realemail" id="" value="<?php echo $email;?>">
            ...
            <textarea name="address" id="address" cols="30" rows="05" class="inputarea"><?php echo $address;?>
            </textarea>
            <input type="hidden" name="id" value="<?php echo $id;?>">
             <input type="submit" value="Update Employee Details" class="btn" name="update">
        </form>
    </div>
   <?php
